...
dataset="SKCM_GSE148190"
data_dir <- "/athena/abc/scratch/paz2005/projects/2022_07_klebanoff_fei_scRNAseq/datasets/SKCM_GSE148190/"
...
metadata <- fread(paste0(data_dir, "SKCM_GSE148190_metadata.csv"))
...
cell_annot <- fread(paste0(data_dir, "SKCM_GSE148190_CellMetainfo_table.tsv"))
...
prefix = c("GSM4455932_K409_blood_GEX_",
"GSM4455933_K409_LN_GEX_")
