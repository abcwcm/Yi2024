...
dataset="NSCLC_GSE117570"
data_dir <- "/athena/abc/scratch/paz2005/projects/2022_07_klebanoff_fei_scRNAseq/datasets/NSCLC_GSE117570/"
...
metadata <- fread(paste0(data_dir, "NSCLC_GSE117570_metadata.csv"))
...
cell_annot <- fread(paste0(data_dir, "NSCLC_GSE117570_CellMetainfo_table.tsv"))
...
The GEO files have cells labeled like so:


[1] "AAACCTGGTACAGACG-1" "AAACGGGGTAGCGCTC-1" "AAACGGGGTCCTCTTG-1"
[4] "AAACGGGTCCAAACAC-1" "AAACGGGTCTTTAGTC-1" "AAAGATGCAGGATTGG-1"
[7] "AAAGATGCATCTACGA-1" "AAAGATGCATTGAGCT-1" "AAAGATGGTTCAGTAC-1"

However, the TISCH cell IDs have cell names that can't be matched:

[1] "P3_Tumor_233"  "P3_Normal_174" "P3_Normal_267" "P3_Normal_291"
[5] "P3_Normal_300" "P3_Normal_332"

Thus, if we want to use the TISH cell annotations (and we do), then we should also use the TISH expression matrix:

https://biostorage.s3.ap-northeast-2.amazonaws.com/TISCH_Data_1002/NSCLC_GSE117570/NSCLC_GSE117570_expression.h5
...
# https://gist.github.com/slowkow/d3c4b77c9bf2a75f6dad4843d7d3aefc

my_h5_file="NSCLC_GSE117570_expression.h5"
barcodes = as.character(h5read(my_h5_file, "matrix/barcodes"))
...
## add metadata
k <- 2
sce.all$Sample = substr(colData(sce.all)$Cell, 1, sapply(gregexpr("_", colData(sce.all)$Cell), "[", k) - 1)
